					...
					<div class="column col-sm-10 col-xs-11" id="main">
						...
						<div class="navbar navbar-blue navbar-static-top">  
							...
							<ul class="nav navbar-nav">
							  ...
							  <li>
								<a href="post.php" role="button" data-toggle="modal">Post</a>
							  </li>
							  <li>
								 ...
								 <div class="col-sm-5">
									  ...
									  <div class="well"> 
										   <form class="form-horizontal" role="form">
											...
											<button class="btn btn-primary pull-right" type="button">Post</button><ul class="list-inline"><li><a href=""></a></li></ul>
										  </form>
									  </div>
										 ...
										 <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Stackoverflow</h4></div>
										  <div class="panel-body">
											...
											<div class="input-group">
											  <div class="input-group-btn">
											  <button class="btn btn-default">+1</button><button class="btn btn-default"></button>
											  </div>
		  ...
		  <div class="modal-content">
			  ...
			  <div class="modal-footer">
				  ...
				  <button class="btn btn-primary btn-sm" data-dismiss="modal" aria-hidden="true">Post</button>
					<ul class="pull-left list-inline"><li><a href=""></a></li></li></ul>
				  </div>	
			  </div>
		  </div>
		  </div>
